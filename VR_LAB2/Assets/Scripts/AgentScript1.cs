...
public class AgentScript1 : Agent
{
...
        Target.localPosition = new Vector3(Random.value * 8 - 4, 0.5f, Random.value * 8 - 4);
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
        ...
        {
            // case 0 is niets
            case 1: controlSignal.z = 1f; break; // Vooruit
            case 2: controlSignal.z = -1f; break; // achteruit
            case 3: controlSignal.x = 1f; break; // Rechts
            case 4: controlSignal.x = -1f; break; // Links
        }
